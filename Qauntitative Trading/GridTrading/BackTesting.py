...
data_path = r"C:\Users\Huang\Work place\Project_Iris\DataAnalysis\DataBase\BTCUSDT_all_5m_data.csv"
start_time = datetime.datetime(2024, 11, 21, 5, 0, 0)
todate_time = datetime.datetime(2025, 2, 3, 2, 0, 0)
...
if __name__ == '__main__':
    ...
    cerebro = bt.Cerebro()
    cerebro.broker.setcommission(commission=0.001, mult=50.0)  # 設定手續費
